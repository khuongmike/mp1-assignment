...
void MP1Node::nodeStart(char *servaddrstr, short servport) {
        ...
        if( !introduceSelfToGroup(&joinaddr) ) {
                finishUpThisNode();
#ifdef DEBUGLOG
                log->LOG(&memberNode->addr, "Unable join self to group. Exiting....");
#endif
                exit(1);
        }
...
bool MP1Node::recvCallBack(void *env, char *data, int size ) {
        ...
        switch (msg->msgType) {
                ...
                case JOINREP:
                        ...
                        stringstream msg;
                        msg << "JOINREP froms " <<  src_addr->getAddress();
                        msg << " data " << *(long*)(data );
                ...
                default:
                        log->LOG(&memberNode->addr, "Received messages other");
                        break;
        }
}
 ...
 *
 * DESCRIPTION: Returns the Address of the coordinator / trả về địa chỉ của coordinator
 */
